  ...
  return (
    <div className="flex min-h-screen bg-canvas">
      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-brand-700 p-12 text-white lg:flex">
        ...
        <div className="relative space-y-1 text-xs text-white/50">
          <p>© {new Date().getFullYear()} Time To Program. All rights reserved.</p>
          <p>
            Website created by <span className="font-semibold text-white/80">Lucky</span>
          </p>
        </div>
      </div>
      ...
      <div className="flex w-full flex-col items-center justify-center px-6 py-12 lg:w-1/2">
        ...
        {/* The left panel is hidden on small screens, so repeat the credit here. */}
        <p className="mt-10 text-xs text-ink-soft lg:hidden">
          Website created by <span className="font-semibold text-ink">Lucky</span>
        </p>
      </div>
    </div>
  );
